...
class ArrTest extends TestCase
{
    ...
    {
        $array = Arr::add(['name' => 'php-script'], 'price', 100);
        $this->assertSame(['name' => 'php-script', 'price' => 100], $array);
    }
    ...
    {
        list($keys, $values) = Arr::divide(['name' => 'php-script']);
        $this->assertSame(['name'], $keys);
        $this->assertSame(['php-script'], $values);
    }
    ...
    {
        $array = ['name' => 'php-script', 'price' => 100];
        $array = Arr::except($array, ['price']);
        $this->assertSame(['name' => 'php-script'], $array);
    }
    ...
    {
        $array = ['name' => 'php-script', 'price' => 100, 'orders' => 10];
    ...
    public function testPull()
    {
        ...
        $this->assertSame('php-script', $name);
